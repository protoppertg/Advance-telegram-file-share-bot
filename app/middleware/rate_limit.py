    ...
    async def __call__(self, handler: Callable[[TelegramObject, dict[str, Any]], Awaitable[Any]], event: TelegramObject, data: dict[str, Any]) -> Any:
        ...
        if is_search:
            ...
            if db_user.search_count >= limit:
                ...
                logger.info("search_rate_limited", user_id=db_user.telegram_id, count=db_user.search_count, limit=limit)
                return
        ...
        if is_upload:
            ...
            if db_user.upload_count >= limit:
                ...
                logger.info("upload_rate_limited", user_id=db_user.telegram_id, count=db_user.upload_count, limit=limit)
                return
